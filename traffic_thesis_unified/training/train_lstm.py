...
def main():
    ...
    model.load_state_dict(torch.load("checkpoints/lstm_model.pth", map_location=device))
    ...
    print("Saved checkpoint: checkpoints/lstm_model.pth")
    print("Saved results: results/lstm_results.csv")
    print(results)
