...
def main():
    ...
    model.load_state_dict(torch.load("checkpoints/cnn_model.pth", map_location=device))
    ...
    print("Saved checkpoint: checkpoints/cnn_model.pth")
    print("Saved results: results/cnn_results.csv")
    print(results)
